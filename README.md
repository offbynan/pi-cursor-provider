...
**This fork improves on the upstream across five areas:**
...
- **Missing features** — base64 image support forwarded end-to-end; inline `<think>` / `<reasoning>` tags stripped and routed to `reasoning_content`
